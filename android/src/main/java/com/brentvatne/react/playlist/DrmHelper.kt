...
object DrmHelper {
     ...
     */
    fun buildDrmSessionManager(context: Context, drm: PlaylistDrm): DrmSessionManager {
     ...
     */
    fun buildMediaItemWithDrm(uri: String, drm: PlaylistDrm?): MediaItem {
