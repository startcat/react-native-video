...
export function resolveAssetSourceForVideo(source: Source): ReactVideoSourceProperties {
...
export function getReactTag(
	ref: RefObject<Component<unknown, unknown, unknown> | ComponentClass<unknown, unknown> | null>
): number {
	if (!ref.current) {
