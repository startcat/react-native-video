 ...
 *
 * NOTE(PLAYER-266): This is the real module types.ts from refactor_androidauto.
 * The harness-local MediaItem stub (added in PLAYER-265) is superseded by this
 * file. browseTreeAdapter.ts and its tests import MediaItem from here directly.
 */
