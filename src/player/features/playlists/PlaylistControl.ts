...
export class PlaylistControl {
   ...
   */
  static onItemCompleted(callback: (event: PlaylistItemCompletedEvent) => void): EmitterSubscription {
   ...
   * Útil para sincronizar con ReactExoplayerView
   */
  static onControlAction(callback: (event: PlaylistControlActionEvent) => void): EmitterSubscription {
   ...
   */
  static onPlaybackStateChanged(callback: (event: PlaylistPlaybackStateChangedEvent) => void): EmitterSubscription {
