...
export class SampleAnalyticsFactory extends BaseAnalyticsPluginFactory {
    ...
    protected static mapMediaDataToComscoreMetadata(mediaData: MediaDto | StreamDto | null): any {
        return {
            ...
            c4: mediaData.series ? `${mediaData.series.name}_S${mediaData.series.season}E${mediaData.series.episode}` : mediaData.title,
            c6: mediaData.id,
    ...
    // @ts-ignore
    static createComscorePlugin(mediaData: MediaDto | StreamDto | null): PlayerAnalyticsPlugin | null {
