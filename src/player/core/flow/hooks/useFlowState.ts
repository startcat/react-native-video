...
function mapStateToInfo(state: any): FlowStateInfo {
    ...
    return {
        ...
        // Estados agregados
        isPlaying: stateType === MediaFlowStateType.PLAYING_TUDUM || 
               stateType === MediaFlowStateType.PLAYING_CONTENT,
        isPreparing: stateType === MediaFlowStateType.PREPARING_TUDUM || 
                 stateType === MediaFlowStateType.PREPARING_CONTENT,
        isActive: stateType !== MediaFlowStateType.IDLE && 
